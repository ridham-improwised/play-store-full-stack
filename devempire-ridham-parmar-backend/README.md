...
---
## Download CSV files
- googleplaystore.csv [download](https://www.kaggle.com/datasets/lava18/google-play-store-apps?select=googleplaystore.csv)
- googleplaystore_user_reviews.csv [download](https://www.kaggle.com/datasets/lava18/google-play-store-apps?select=googleplaystore_user_reviews.csv)

- After downloading the above files keep them in root directory.
For testing purpose you need to create a file googleplaystore_dummy_apps.csv and copy first 4 rows in file and put into root directory
